...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="card-text-sm text-center mt-4 mb-0">
            Already registered? <a href="<?php echo e(route('login')); ?>">Sign in</a>
        </p>
    </form>
...
<?php endif; ?>
<?php /**PATH E:\Herd\devops-php-infrastructure\VM2-Application-Server-1\app-user-dashboard\src\resources\views/auth/register.blade.php ENDPATH**/ ?>