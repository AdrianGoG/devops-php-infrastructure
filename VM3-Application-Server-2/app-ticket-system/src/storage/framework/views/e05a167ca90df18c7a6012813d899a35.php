...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Tickets'); ?> · Helpdesk</title>
...
<body>
    <nav class="navbar navbar-expand-lg app-nav py-2">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('tickets.index')); ?>">
                <span class="brand-mark">TCK</span>
                <span class="brand-text">
                    <span>Helpdesk</span>
                    <small>VM3 · app-ticket-system · PHP <?php echo e(PHP_VERSION); ?></small>
                </span>
            </a>

            <a href="<?php echo e(route('tickets.create')); ?>" class="btn btn-accent btn-sm">+ New ticket</a>
        </div>
    </nav>
...
<?php /**PATH E:\Herd\devops-php-infrastructure\VM3-Application-Server-2\app-ticket-system\src\resources\views/layouts/app.blade.php ENDPATH**/ ?>